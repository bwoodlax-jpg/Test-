...
WATCHLIST = [
    ...
    {"ticker": "DELL", "company": "Dell Technologies Inc",     "tier": "AI Server Assembly","tier_class": "t2", "entry": "$335–$355", "target": "$497", "stop": "$310",  "catalyst": "Q1 FY27: AI server rev $16.1B (+757% YoY); $51.3B record backlog; $24.4B new AI orders; FY guide $165–169B", "note": "ZONE REDRAWN Jun 11 — gap-fill $335–355 after parabolic spike blew through original $420–450 zone. Thesis intact. R/R 4.3:1. Entry requires stabilization + Warsh Jun 16–17 clearance."},
