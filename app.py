...
WATCHLIST = [
    ...
    {"ticker": "PLTR", "company": "Palantir Technologies",     "tier": "AI Operating System","tier_class": "t1", "entry": "$125–$140",  "target": "$183", "stop": "$108",  "catalyst": "85% YoY revenue; $7.65B FY2026 guide; government ATO lock-in; commercial AIP tripling", "note": "AI data fabric for government + enterprise. 139% NRR. Verified ~$130 May 26."},
]
